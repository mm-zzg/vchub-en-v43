...
Projects are used to manage the visualization elements of the **WAGO SCADA** system, and through multi-project management, it is possible to clearly differentiate between the presentation and design of configuration screens in several industrial application scenarios. In a project, **configuration controls**, **tag** **s** and **scripts** allow the user to freely configure a variety of digital visualization interfaces in order to cope with different industrial production scenarios.

In the WAGO SCADA system, the project is a configuration unit that contains:
...
Through the screen jump function in the configuration, the workshop controls in the overview screen of the "Factory" and the screens in each workshop project are associated to realize the multi-level management of the production environment. environment.
...
Select any project and click Design button to open the project design page, as shown in the figure below, which allows users to perform configuration.
...
Select any project, click **Copy** button on the right side, an edit box will pop up, the default name of the copied project is "{original project name}_Copy", users can modify the name, description and project picture according to requirements
