# Current Workspace Configure File
  ...
  The current workspace configuration file is a .ini suffixed configuration file containing configuration information that is used as a basis for the WAGO SCADA service when it is started.
