# Devices
 ...
 The WAGO SCADA supports a wide range of communication protocols, so you only need to configure the appropriate communication driver for each hardware device.

 To quickly connect to one of your devices, click on the "Devices" menu of the WAGO SCADA and select the type of device you want to add.
