...
The Modbus RTU driver in WAGO SCADA communicates data with devices (typically PLCs, sensors or other industrial devices) via the COM port. The driver handles the underlying details of the Modbus RTU communication protocol and ensures that reliable serial data interaction between devices is possible.
