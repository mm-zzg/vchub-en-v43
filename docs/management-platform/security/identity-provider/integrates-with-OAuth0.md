...
WAGO SCADA is compatible with OpenID Connect (OIDC) and can seamlessly integrate with Auth0.
...
5. Click the "Create Application Button", then a Create application form popup. There are 4 application type to be selected. WAGO SCADA uses Authorization Code of OIDC protocol, the corresponding application type is the **"Regular Web Applications"** type.
