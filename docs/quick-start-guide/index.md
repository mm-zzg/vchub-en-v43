...
After the installation of WAGO SCADA, a SQLite database will be automatically created, which you can use for basic testing. You can also click "Database" -> "Database Connection" page and then click the "New" button to create a new database connection. See details in [Database Connection](./management-platform/databases/database-connection/index.md).
...
At the top of the tag editing page, enable history to store the value of the tag historically. See details in [history](../management-platform/assets-and-tags/tag/tag-properties/history.md)
